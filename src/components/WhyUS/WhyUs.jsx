  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row justify-center">
        <div className="lg:w-[50%] p-4 lg:p-6">
          <div data-aos="fade-right" className="flex flex-col gap-4">
            <p>
              ...
              innovative results tailored to your business needs. Whether you're
              looking to build a custom website, develop an app, or streamline
              your digital strategy, our skilled team is here to bring your
        ...
        <div className="lg:w-[50%] p-4 lg:p-6 self-center" data-aos="fade-left">
          <img
