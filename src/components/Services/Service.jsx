const Service = ({ path, title, description }) => {
  return (
    <>
      <div className="flex flex-col items-center gap-6 w-[370px] h-[400px]  p-4 rounded-br-[6rem] rounded-xl hover:bg-black hover:text-white transition-colors duration-300">
