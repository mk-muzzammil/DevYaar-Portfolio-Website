...
const LogoCrousal = () => {
  return (
    <div className="relative py-4 dark:bg-primary">
      ...
      <div className="absolute inset-y-0 left-0 w-32 bg-white dark:bg-black z-10"></div>
      <div className="absolute inset-y-0 right-0 w-32 bg-white z-10 dark:bg-black"></div>
