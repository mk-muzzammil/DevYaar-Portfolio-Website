    ...
    return (
        <footer className="bg-black text-white py-4 px-6 sm:px-12 md:px-24 flex flex-col sm:flex-row sm:justify-between items-center">
            <div className="flex items-center mb-4 justify-center sm:justify-start sm:mb-0 sm:order-none w-[40%]">
                <img src="/public/images/logo.png" alt="Logo" className="h-8 mr-4" />
            </div >
            ...
            <div className="flex space-x-4 order-1 sm:order-none">
                <a href="https://www.instagram.com/devyaar.official/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-400">
                    <FaInstagram size={20} />
                </a>
                <a href="https://www.linkedin.com/in/dev-yaar/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-400">
                    <FaLinkedin size={20} />
                </a>
                <a href="https://www.facebook.com/profile.php?id=61565335510626" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-400">
                    <FaFacebookF size={20} />
                </a>
            </div>
            </div>
